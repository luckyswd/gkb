...
class Mappress {
	...
	*/
	...
	static function l10n() {
		...
		'searchBox', 'searchPlaceholder', 'size', 'sizes', 'style', 'thumbHeight', 'thumbWidth', 'thumbs', 'thumbsList', 'thumbsPopup', 'tooltips', 'userLocation',
		'webComponent');
	...
	*/
	...
	static function scripts_register($scripts = null) {
		...
		// Dependencies
		$deps = array('underscore', 'wp-element', 'wp-i18n');
	...
	* 2.85.8 may no longer be necessary?
	*/
