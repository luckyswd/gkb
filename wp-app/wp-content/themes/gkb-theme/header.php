...
<head>
    ...
    <meta name="yandex-verification" content="56c82ebe91ca39d9" />
    <title><?php wp_title('«', true, 'right'); ?><?php bloginfo('name'); ?></title>
    <link rel="pingback" href="<?php bloginfo('pingback_url'); ?>"/>
    <?php wp_head(); ?>
    <?php if (home_url() == 'https://gazkotelbel.com' ) :?>
    ...
    <noscript>
        <div><img src="https://mc.yandex.ru/watch/94762651" style="position:absolute; left:-9999px;" alt=""/></div>
    </noscript>
    <!-- /Yandex.Metrika counter -->
    <?php endif; ?>
...
$categories = get_terms(['taxonomy' => 'product-category',
'orderby' => 'term_id',
'order' => 'ASC',
'hide_empty' => true,]);
?>
            ...
            <?php endif; ?>
                ...
                <div class="header__burger-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000"
                         height="800px" width="800px" version="1.1" id="Layer_1" viewBox="0 0 150 150"
                         xml:space="preserve">
                <g id="XMLID_240_">
                    <path id="XMLID_241_"
        ...
        <div class="container">
            ...
            <div class="header__categories header__menu">
                ...
                <?php foreach ($categories as $category) : ?>
                        <?php
                $productsByCategory = get_posts(['post_type' => 'products',
                'posts_per_page' => -1,
                'tax_query' => [['taxonomy' => 'product-category',
                'field' => 'term_id',
